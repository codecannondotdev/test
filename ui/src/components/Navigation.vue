	...
	<div
		...
		<div class="navigation__links-container">
			...
			<router-link
				...
				<i class="navigation__link-icon far fa-light fa-chalkboard-teacher"></i>
				<div class="navigation__link-title">Instructors</div>
			</router-link>
			<router-link
				class="navigation__link-item"
				:to="{ name: 'studios-list' }">
				<i class="navigation__link-icon far fa-light fa-building"></i>
				<div class="navigation__link-title">Studios</div>
			</router-link>
			<router-link
				class="navigation__link-item"
				:to="{ name: 'equipments-list' }">
				<i class="navigation__link-icon far fa-light fa-tools"></i>
				<div class="navigation__link-title">Equipments</div>
			</router-link>
			<router-link
				class="navigation__link-item"
			...
			<router-link
				...
				<i class="navigation__link-icon far fa-light fa-graduation-cap"></i>
				<div class="navigation__link-title">Programs</div>
			</router-link>
			<router-link
				class="navigation__link-item"
				:to="{ name: 'feedbacks-list' }">
				<i class="navigation__link-icon far fa-light fa-comment-dots"></i>
				<div class="navigation__link-title">Feedbacks</div>
			</router-link>
			<router-link
				class="navigation__link-item"
			...
			<router-link
				class="navigation__link-item"
				:to="{ name: 'testers-list' }">
				<i class="navigation__link-icon far far fa-cucumber"></i>
				<div class="navigation__link-title">Testers</div>
			</router-link>
			<router-link
