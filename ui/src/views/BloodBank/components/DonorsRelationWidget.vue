<template>
	<Card class="donors-relation-widget">
		<template #title>
			<h4 class="donors-relation-widget__title">Donors</h4>
			<Button
				icon="fal fa-link"
				label="Connect"
				outlined
	...
	<DonorForm
		...
		:attach-to="{ bloodBanks: { method: 'syncWithoutDetaching', id: props.bloodBankId } }"
...
import DonorsRelationAddDialog from './DonorsRelationAddDialog.vue'
import DonorForm from '@/views/Donor/components/Form.vue'
...
async function detach(item: Donor) {
