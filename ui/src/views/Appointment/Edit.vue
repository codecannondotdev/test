<template>
	...
	<Container class="edit">
		...
		<TreatmentRelationWidget
			v-if="isEdit"
			:appointment-id="route.params.id as string"
			@start-loading="loaders.add('Treatment')"
			@stop-loading="loaders.delete('Treatment')" />
	</Container>
</template>
...
import TreatmentRelationWidget from './components/TreatmentRelationWidget.vue'
