<template>
	...
	<Container class="edit">
		...
		<HeadedDepartmentRelationWidget
			v-if="isEdit"
			:doctor-id="route.params.id as string"
			@start-loading="loaders.add('Headed Department')"
			@stop-loading="loaders.delete('Headed Department')" />
	</Container>
</template>
...
import HeadedDepartmentRelationWidget from './components/HeadedDepartmentRelationWidget.vue'
