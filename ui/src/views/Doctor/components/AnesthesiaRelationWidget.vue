<template>
	<Card class="anesthesia-relation-widget">
		<template #title>
			<h4 class="anesthesia-relation-widget__title">Anesthesia</h4>
			<Button
				icon="fal fa-link"
				label="Connect"
				outlined
	...
	<AnesthesiaForm
		...
		:force-values="{ anesthesiologist_id: Number(props.doctorId) }"
		:hide-inputs="['anesthesiologist_id']"
...
import AnesthesiaRelationAddDialog from './AnesthesiaRelationAddDialog.vue'
...
async function dissociate(item: Anesthesia) {
	...
	:deep(.p-card-body) {
		...
		.p-card-caption {
			...
			.p-card-title {
				...
				.anesthesia-relation-widget__title {
					flex: 1;
					text-align: left;
				}
			}
