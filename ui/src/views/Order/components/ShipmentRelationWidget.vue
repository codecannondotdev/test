<template>
	<Card class="shipment-relation-widget">
		<template #title>
			<h4 class="shipment-relation-widget__title">Shipment</h4>
			<Button
				icon="fal fa-link"
				label="Connect"
				outlined
...
import ShipmentRelationAddDialog from './ShipmentRelationAddDialog.vue'
	...
	:deep(.p-card-body) {
		...
		.p-card-caption {
			...
			.p-card-title {
				...
				.shipment-relation-widget__title {
					flex: 1;
					text-align: left;
				}
			}
