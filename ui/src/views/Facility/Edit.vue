<template>
	...
	<Container class="edit">
		...
		<EquipmentRelationWidget
			v-if="isEdit"
			:facility-id="route.params.id as string"
			@start-loading="loaders.add('Equipment')"
			@stop-loading="loaders.delete('Equipment')" />
...
import EquipmentRelationWidget from './components/EquipmentRelationWidget.vue'
