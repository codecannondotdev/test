<template>
	...
	<Container class="edit">
		...
		<FeedbacksRelationWidget
			v-if="isEdit"
			:class-model-id="route.params.id as string"
			@start-loading="loaders.add('Feedbacks')"
			@stop-loading="loaders.delete('Feedbacks')" />
	</Container>
</template>
...
import FeedbacksRelationWidget from './components/FeedbacksRelationWidget.vue'
