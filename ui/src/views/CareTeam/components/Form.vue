<template>
	<FormContainer
		class="form"
		:visible
		:title="props.isEdit ? 'Update CareTeam' : 'Create CareTeam'"
		:as-dialog
		@close="emit('close')">
		<form @submit.prevent="submit">
			...
			<FormInput
				v-if="!props.hideInputs?.includes('scope')"
				:required="false"
				:error-message="formErrors.scope"
				label="Scope">
				<Textarea
					v-model="formData.scope"
					:disabled="!!props.forceValues.scope"
					rows="5"
					cols="50" />
			</FormInput>
...
const { formData, loading, formErrors, reset, submit, remove } = useForm({
	...
	onCreated: (entity) => {
		if (props.shouldRedirect) {
			router.push({ name: 'care-teams-edit', params: { id: entity!.id } })
		}
		emit('created', entity)
	},
