<template>
	<Header :title="isEdit ? 'Edit BloodProduct' : 'Create BloodProduct'" />
	<ProgressBar
		v-if="loaders.size > 0"
		mode="indeterminate"
	...
	<Container class="edit">
		<Form
			...
			@deleted="router.push({ name: 'blood-products-list' })" />
		<TransfusionsRelationWidget
			v-if="isEdit"
			:blood-product-id="route.params.id as string"
...
const isEdit = computed(() => route.name === 'blood-products-edit')
