<template>
	<div class="header-toolbar">
		<Button
			...
			severity="secondary"
			@click="router.push({ name: 'medical-device-maintenances-list' })" />
		<h2>{{ props.title }}</h2>
		<InputText
		...
		<Button
			...
			icon="fal fa-plus"
			label="Create"
			@click="router.push({ name: 'medical-device-maintenances-create' })" />
	</div>
</template>
...
const isList = computed(() => route.name === 'medical-device-maintenances-list')
