<template>
	<Card class="waiting-lists-relation-widget">
		<template #title>
			<h4 class="waiting-lists-relation-widget__title">Waiting Lists</h4>
			<Button
				icon="fal fa-link"
				label="Connect"
				outlined
...
import WaitingListsRelationAddDialog from './WaitingListsRelationAddDialog.vue'
	...
	:deep(.p-card-body) {
		...
		.p-card-caption {
			...
			.p-card-title {
				...
				.waiting-lists-relation-widget__title {
					flex: 1;
					text-align: left;
				}
			}
