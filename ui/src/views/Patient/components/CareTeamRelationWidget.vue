<template>
	<Card class="care-team-relation-widget">
		<template #title>
			<h4 class="care-team-relation-widget__title">Care Team</h4>
			<Button
				icon="fal fa-link"
				label="Connect"
				outlined
...
import CareTeamRelationAddDialog from './CareTeamRelationAddDialog.vue'
import CareTeamForm from '@/views/CareTeam/components/Form.vue'
...
async function detach(item: CareTeam) {
	...
	:deep(.p-card-body) {
		...
		.p-card-caption {
			...
			.p-card-title {
				...
				.care-team-relation-widget__title {
					flex: 1;
					text-align: left;
				}
			}
