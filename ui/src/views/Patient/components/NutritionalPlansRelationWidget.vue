<template>
	<Card class="nutritional-plans-relation-widget">
		<template #title>
			<h4 class="nutritional-plans-relation-widget__title">Nutritional Plans</h4>
			<Button
				icon="fal fa-link"
				label="Connect"
				outlined
	...
	<NutritionalPlansRelationAddDialog
...
import NutritionalPlansRelationAddDialog from './NutritionalPlansRelationAddDialog.vue'
import NutritionalPlanForm from '@/views/NutritionalPlan/components/Form.vue'
...
async function dissociate(item: NutritionalPlan) {
...
.nutritional-plans-relation-widget {
	width: 100%;
	max-width: 600px;
	overflow: hidden;
	...
	:deep(.p-card-body) {
		...
		.p-card-caption {
			...
			.p-card-title {
				...
				.nutritional-plans-relation-widget__title {
					flex: 1;
					text-align: left;
				}
			}
