<template>
	<Card class="inventories-relation-widget">
		<template #title>
			<h4 class="inventories-relation-widget__title">Inventories</h4>
			<Button
				icon="fal fa-link"
				label="Connect"
				outlined
...
import InventoriesRelationAddDialog from './InventoriesRelationAddDialog.vue'
	...
	:deep(.p-card-body) {
		...
		.p-card-caption {
			...
			.p-card-title {
				...
				.inventories-relation-widget__title {
					flex: 1;
					text-align: left;
				}
			}
