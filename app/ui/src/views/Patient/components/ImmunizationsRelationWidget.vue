<template>
	<Card class="immunizations-relation-widget">
		<template #title>
			<h4 class="immunizations-relation-widget__title">Immunizations</h4>
			<Button
				icon="fal fa-link"
				label="Connect"
				outlined
	...
	<ImmunizationsRelationAddDialog
...
import ImmunizationsRelationAddDialog from './ImmunizationsRelationAddDialog.vue'
import ImmunizationForm from '@/views/Immunization/components/Form.vue'
...
async function detach(item: Immunization) {
	...
	:deep(.p-card-body) {
		...
		.p-card-caption {
			...
			.p-card-title {
				...
				.immunizations-relation-widget__title {
					flex: 1;
					text-align: left;
				}
			}
