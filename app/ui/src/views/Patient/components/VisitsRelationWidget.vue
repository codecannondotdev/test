<template>
	<Card class="visits-relation-widget">
		<template #title>
			<h4 class="visits-relation-widget__title">Visits</h4>
			<Button
				icon="fal fa-link"
				label="Connect"
				outlined
...
import VisitsRelationAddDialog from './VisitsRelationAddDialog.vue'
import VisitForm from '@/views/Visit/components/Form.vue'
...
async function dissociate(item: Visit) {
