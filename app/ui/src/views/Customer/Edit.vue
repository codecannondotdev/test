<template>
	...
	<Container class="edit">
		...
		<OrdersRelationWidget
			v-if="isEdit"
			:customer-id="route.params.id as string"
			@start-loading="loaders.add('Orders')"
			@stop-loading="loaders.delete('Orders')" />
...
import OrdersRelationWidget from './components/OrdersRelationWidget.vue'
