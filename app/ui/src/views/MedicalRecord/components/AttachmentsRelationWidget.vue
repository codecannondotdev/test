<template>
	<Card class="attachments-relation-widget">
		<template #title>
			<h4 class="attachments-relation-widget__title">Attachments</h4>
			<Button
				icon="fal fa-link"
				label="Connect"
				outlined
...
import AttachmentsRelationAddDialog from './AttachmentsRelationAddDialog.vue'
	...
	:deep(.p-card-body) {
		...
		.p-card-caption {
			...
			.p-card-title {
				...
				.attachments-relation-widget__title {
					flex: 1;
					text-align: left;
				}
			}
