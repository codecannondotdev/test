<template>
	<Card class="follow-up-appointments-relation-widget">
		<template #title>
			<h4 class="follow-up-appointments-relation-widget__title">Follow Up Appointments</h4>
			<Button
				icon="fal fa-link"
				label="Connect"
				outlined
	...
	<FollowUpAppointmentsRelationAddDialog
...
import FollowUpAppointmentsRelationAddDialog from './FollowUpAppointmentsRelationAddDialog.vue'
...
.follow-up-appointments-relation-widget {
	width: 100%;
	max-width: 600px;
	overflow: hidden;
	...
	:deep(.p-card-body) {
		...
		.p-card-caption {
			...
			.p-card-title {
				...
				.follow-up-appointments-relation-widget__title {
					flex: 1;
					text-align: left;
				}
			}
