<template>
	<Card class="waiting-list-relation-widget">
		<template #title>
			<h4 class="waiting-list-relation-widget__title">Waiting List</h4>
			<Button
				icon="fal fa-link"
				label="Connect"
				outlined
...
import WaitingListRelationAddDialog from './WaitingListRelationAddDialog.vue'
	...
	:deep(.p-card-body) {
		...
		.p-card-caption {
			...
			.p-card-title {
				...
				.waiting-list-relation-widget__title {
					flex: 1;
					text-align: left;
				}
			}
