<template>
	<Card class="shifts-relation-widget">
		<template #title>
			<h4 class="shifts-relation-widget__title">Shifts</h4>
			<Button
				icon="fal fa-link"
				label="Connect"
				outlined
	...
	<ShiftsRelationAddDialog
		v-model="isRelationAddDialogActive"
		:staff-role-id="props.staffRoleId"
		@update="refresh()" />
	<ShiftForm
		:as-dialog="true"
		:visible="isFormActive"
		:should-redirect="false"
		:attach-to="{ staffRoles: { method: 'syncWithoutDetaching', id: props.staffRoleId } }"
...
import ShiftsRelationAddDialog from './ShiftsRelationAddDialog.vue'
import ShiftForm from '@/views/Shift/components/Form.vue'
...
async function detach(item: Shift) {
