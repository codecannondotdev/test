<template>
	<div class="header-toolbar">
		<Button
			...
			severity="secondary"
			@click="router.push({ name: 'financial-transactions-list' })" />
		<h2>{{ props.title }}</h2>
		<InputText
		...
		<Button
			...
			icon="fal fa-plus"
			label="Create"
			@click="router.push({ name: 'financial-transactions-create' })" />
	</div>
</template>
...
const isList = computed(() => route.name === 'financial-transactions-list')
