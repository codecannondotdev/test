<template>
	<Card class="products-relation-widget">
		<template #title>
			<h4 class="products-relation-widget__title">Products</h4>
			<Button
				icon="fal fa-link"
				label="Connect"
				outlined
...
import ProductsRelationAddDialog from './ProductsRelationAddDialog.vue'
...
async function dissociate(item: Product) {
	...
	:deep(.p-card-body) {
		...
		.p-card-caption {
			...
			.p-card-title {
				...
				.products-relation-widget__title {
					flex: 1;
					text-align: left;
				}
			}
