<template>
	<FormContainer
		class="form"
		:visible
		:title="props.isEdit ? 'Update ImagingStudy' : 'Create ImagingStudy'"
		:as-dialog
		@close="emit('close')">
		<form @submit.prevent="submit">
			...
			<FormInput
				v-if="!props.hideInputs?.includes('study_date')"
				:required="true"
				:error-message="formErrors.study_date"
				label="Study Date">
				<DatePicker
					:model-value="formData.study_date ? new Date(formData.study_date) : undefined"
					:disabled="!!props.forceValues.study_date"
					selectionMode="single"
					@update:model-value="formData.study_date = ($event as Date).toISOString()" />
			</FormInput>
			<FormInput
...
const { formData, loading, formErrors, reset, submit, remove } = useForm({
	...
	onCreated: (entity) => {
		if (props.shouldRedirect) {
			router.push({ name: 'imaging-studies-edit', params: { id: entity!.id } })
		}
		emit('created', entity)
	},
