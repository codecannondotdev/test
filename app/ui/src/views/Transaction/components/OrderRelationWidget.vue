<template>
	<Card class="order-relation-widget">
		<template #title>
			<h4 class="order-relation-widget__title">Order</h4>
			<Button
				icon="fal fa-link"
				label="Connect"
				outlined
	...
	<OrderForm
		...
		:attach-to="{ transactions: { method: 'syncWithoutDetaching', id: props.transactionId } }"
...
import OrderRelationAddDialog from './OrderRelationAddDialog.vue'
...
async function detach(item: Order) {
