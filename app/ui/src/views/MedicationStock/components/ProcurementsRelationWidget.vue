<template>
	<Card class="procurements-relation-widget">
		<template #title>
			<h4 class="procurements-relation-widget__title">Procurements</h4>
			<Button
				icon="fal fa-link"
				label="Connect"
				outlined
	...
	<ProcurementsRelationAddDialog
		v-model="isRelationAddDialogActive"
		:medication-stock-id="props.medicationStockId"
		@update="refresh()" />
	<ProcurementOrderForm
		:as-dialog="true"
		:visible="isFormActive"
		:should-redirect="false"
		:force-values="{ stock_id: Number(props.medicationStockId) }"
		:hide-inputs="['stock_id']"
...
import ProcurementsRelationAddDialog from './ProcurementsRelationAddDialog.vue'
	...
	:deep(.p-card-body) {
		...
		.p-card-caption {
			...
			.p-card-title {
				...
				.procurements-relation-widget__title {
					flex: 1;
					text-align: left;
				}
			}
