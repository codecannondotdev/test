<template>
	...
	<FinancialTransactionRelationAddDialog
		...
		:claim-adjustment-id="props.claimAdjustmentId"
		@update="refresh()" />
	<FinancialTransactionForm
		:as-dialog="true"
		:visible="isFormActive"
		:should-redirect="false"
		:force-values="{ claim_adjustment_id: Number(props.claimAdjustmentId) }"
		:hide-inputs="['claim_adjustment_id']"
...
import { useClaimAdjustmentDetailsState } from '@/models/ClaimAdjustment/States'
...
const detailsState = useClaimAdjustmentDetailsState()
...
async function refresh() {
	...
	emit('start-loading')
	try {
		await detailsState.getDetails(props.claimAdjustmentId, { with: ['financialTransaction'] })
	} finally {
